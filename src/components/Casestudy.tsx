    ...
    <div className="flex-1 overflow-y-auto">
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="mt-6 rounded-xl border border-border bg-card p-5">
          ...
          <h3 className="text-base font-semibold mt-6">Trả lời</h3>
          <div className="mt-3 space-y-4 text-base text-foreground/85 leading-relaxed whitespace-pre-line">
            <div>
              ...
              <div className="mt-1">
                ...
                {'\n\n'}
                Quan điểm A đúng khi khẳng định thành tựu lớn về mặt chính trị: 54 dân tộc chung sống hòa bình, không có
                xung đột sắc tộc là minh chứng rõ nét cho chính sách đại đoàn kết dân tộc và bình đẳng về quyền chính
                trị. Tuy nhiên, A chưa chính xác khi dùng cụm từ “thành công hoàn toàn”, vì bình đẳng dân tộc là quá
                trình lâu dài, không chỉ dừng lại ở việc không có xung đột.
                {'\n'}
                ...
                sách dân tộc, vì sự ổn định chính trị chính là nền tảng quan trọng để tiếp tục thu hẹp những chênh lệch
                đó.
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-1">
                ...
                mặt mà khoảng cách phát triển giữa các dân tộc vẫn lớn, thì đó mới chỉ là bình đẳng hình thức, chưa đạt
                được mục tiêu thực sự của chủ nghĩa Mác - Lênin.
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-1">
                Nhóm nhận định: Thách thức lớn nhất hiện nay là thực hiện bình đẳng thực tế thông qua việc thu hẹp khoảng
                cách phát triển kinh tế - xã hội giữa các dân tộc.
                {'\n'}
                Lý do:
                {'\n\n'}
                ...
                {'\n'}
                - Trong bối cảnh cách mạng công nghiệp 4.0, nếu không có chính sách đặc thù mạnh mẽ, khoảng cách này có
                nguy cơ bị kéo rộng thêm.
                {'\n\n'}
                Kết luận: Chính sách dân tộc của Đảng đang chuyển hướng mạnh mẽ từ “đảm bảo ổn định” sang “ưu tiên phát
                triển bền vững và thu hẹp khoảng cách” ở vùng đồng bào dân tộc thiểu số. Quan điểm của A phản ánh thành
                tựu của giai đoạn trước, còn quan điểm của B phản ánh yêu cầu cấp thiết của giai đoạn hiện nay và tương
                lai.
              </div>
            </div>
          </div>
